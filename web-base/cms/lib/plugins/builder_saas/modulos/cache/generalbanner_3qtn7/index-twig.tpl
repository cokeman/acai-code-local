...
/* index.twig */
if (!class_exists('__TwigTemplate_bfab4ac1ae80c18f8fe2f304755be9529a4efe2915e97e2b489911ffbb32287f')){
class __TwigTemplate_bfab4ac1ae80c18f8fe2f304755be9529a4efe2915e97e2b489911ffbb32287f extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        return new Source("<div class=\"p-12 bg-gray-300 text-gray-600 text-center\">Mi nuevo módulo</div>", "index.twig", "/var/www/vhosts/ws.cocosolution.com/httpdocs/cms/lib/plugins/builder_saas/modulos/cache/generalbanner_3qtn7");
    }
}
}
...
$acaiResultData = new __TwigTemplate_bfab4ac1ae80c18f8fe2f304755be9529a4efe2915e97e2b489911ffbb32287f($twig);
