...
/* index.twig */
if (!class_exists('__TwigTemplate_e4005be774059c8beecc19c38b82fdb1493c6d065aae303280d3af2e3b01822f')){
class __TwigTemplate_e4005be774059c8beecc19c38b82fdb1493c6d065aae303280d3af2e3b01822f extends Template
{
    private $source;
    private $macros = [];
    ...
    public function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        $context["tienda"] = (($__internal_compile_0 = CocoDB::get("configuracion_tienda", "", null, null, [])) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0[0] ?? null) : null);
        // line 2
        $context["config"] = (($__internal_compile_1 = CocoDB::get("configuracion", "", null, null, [])) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1[0] ?? null) : null);
        // line 3
        echo "
";
        // line 4
        echo base64_decode(twig_get_attribute($this->env, $this->source, ($context["config"] ?? null), "scripts_body", [], "any", false, false, false, 4));
        echo "

 ";
        // line 6
        $context["tw_class"] = [0 => "sticky top-0 navbar-wrapper aaaap-2 aaaalg:p-3 w-full z-30 bg-old-gradient--header transition3s"];
        echo " 

 ";
        // line 8
        if ((twig_get_attribute($this->env, $this->source, ($context["thisrecord"] ?? null), "tableName", [], "any", false, false, false, 8) === "apartados_edu")) {
            echo " ";
            $context["tw_class"] = twig_array_merge(($context["tw_class"] ?? null), [0 => "educacion"]);
            echo " ";
        }
        echo " 
 <nav class=\"";
        // line 9
        echo twig_escape_filter($this->env, twig_join_filter(($context["tw_class"] ?? null), " "), "html", null, true);
        echo "\">
    ...
    ";
        // line 31
        echo BuilderModule("nuevomenu_m7gx9k", []);
        echo "
...
";
        ...
        if (false) {
            // line 34
            echo "<div class=\"container-full sm:mx-auto px-2 lg:px-2 flex items-center justify-between text-white\">
        <div class=\"flex items-center flex-row lg:flex-row flex-shrink-0\">
            
";
            // line 37
            if ( !twig_get_attribute($this->env, $this->source, ($context["request"] ?? null), "modo_restringido", [], "any", false, false, false, 37)) {
                // line 38
                echo "<div class=\"block mr-2 lg:mr-0\">
...
";
            ...
            <div class=\"flex items-center flex-shrink-0 ml-2 lg:ml-4\">
                <a href=\"/\" aria-label=\"";
            // line 49
            echo twig_escape_filter($this->env, t_var("Ir a portada"), "html", null, true);
            echo "\">
                    <span class=\"sr-only\">";
            // line 50
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["configuracionRecord"] ?? null), "titulo_de_pagina", [], "any", false, false, false, 50), "html", null, true);
            echo "</span>
                    <img src=\"/template/estandar/images/logo-bl.svg\" alt=\"";
            // line 51
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["configuracionRecord"] ?? null), "titulo_de_pagina", [], "any", false, false, false, 51), "html", null, true);
            echo "\" class=\"h-6 lg:h-8 lg:-mt-2\">
                </a>
            </div>
        ...
        <div class=\"navbar w-full block text-md font-normal flex w-auto justify-end lg:justify-between py-0\">
            ...
            // line 98
            echo twig_escape_filter($this->env, t_var("Buscador"), "html", null, true);
            echo "</label>
...
";
            // line 128
            if ( !twig_get_attribute($this->env, $this->source, ($context["session"] ?? null), "user", [], "any", false, false, false, 128)) {
                // line 129
                echo "<a href=\"/login/\" class=\"menuLink relative menu block flex items-center py-2 lg:py-0 mr-0 lg:mr-4 px-2 hover:text-black text-xs text-right leading-tight\">
...
";
            // line 152
            if (twig_get_attribute($this->env, $this->source, ($context["session"] ?? null), "user", [], "any", false, false, false, 152)) {
                // line 153
                echo "<span class=\"menuLink relative menu block flex items-center py-2 lg:py-0 mr-0 lg:mr-4 px-2 hover:text-black text-xs text-right leading-tight\">
                    ...
                    <div class=\"submenu hidden absolute top-100 right-0 w-64 text-left bg-white p-4 shadow-lg border-t-4 border-orange-500\">
                        <ul>
                            <!--<li class=\"text-xs border-b border-gray-400 mb-2\">
                                <span class=\"block pt-2 px-2  truncate text-gray-600 capitalize\">";
                // line 175
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["session"] ?? null), "user_bd", [], "any", false, false, false, 175), "nombre", [], "any", false, false, false, 175), "html", null, true);
                echo "</span>
                                <span class=\"block pb-4 px-2  truncate text-gray-600 lowercase\">";
                // line 176
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["session"] ?? null), "user_bd", [], "any", false, false, false, 176), "correo", [], "any", false, false, false, 176), "html", null, true);
                echo "</span>
                            </li>-->
                            ";
                // line 178
                $context["apartados"] = CocoDB::get("apartados", "parentNum=21 and visible_en_el_menu=1", "siblingOrder ASC", null, []);
                // line 179
                echo " ";
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(($context["apartados"] ?? null));
                foreach ($context['_seq'] as $context["_key"] => $context["apartado"]) {
                    echo " 
<li><a href=\"";
                    // line 180
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["apartado"], "enlace", [], "any", false, false, false, 180), "html", null, true);
                    echo "\" class=\"block flex items-center py-2 hover:bg-gray-200 px-2\">";
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["apartado"], "name", [], "any", false, false, false, 180), "html", null, true);
                    echo "</a></li>
 ";
                }
                $_parent = $context['_parent'];
                unset($context['_seq'], $context['_iterated'], $context['_key'], $context['apartado'], $context['_parent'], $context['loop']);
...
";
            // line 191
            if (twig_get_attribute($this->env, $this->source, ($context["tienda"] ?? null), "tienda_activa", [], "any", false, false, false, 191)) {
                // line 192
                echo "<span class=\"menuLink relative menu block flex items-center py-2 lg:py-0 mr-0 lg:mr-4 px-2 hover:text-black text-white text-xs text-right leading-tight\">
                    <button onclick=\"toggleSubmenu(this.parentNode)\" class=\"hidden xl:block text-right\">
                        ";
                // line 194
                echo t_var("Mi <br>
                ...
                echo "
                    ...
                    <div class=\"submenu hidden absolute top-100 right-0 w-64 text-left bg-white p-4 shadow-lg border-t-4 border-orange-500\">
                        ";
                // line 204
                echo BuilderModule("cestawidgetcesta_3auuh", []);
                echo "
                    </div>
                </span>
";
...
";
        // line 216
        if (twig_get_attribute($this->env, $this->source, ($context["request"] ?? null), "ver_mensaje_app", [], "any", false, false, false, 216)) {
            // line 217
            echo BuilderModule("appavisoweb_y45157", []);
            echo "
";
        }
    }
    ...
    {
        return array (  345 => 217,  343 => 216,  338 => 213,  331 => 208,  324 => 204,  313 => 195,  310 => 194,  306 => 192,  304 => 191,  299 => 188,  290 => 181,  280 => 180,  273 => 179,  271 => 178,  266 => 176,  262 => 175,  238 => 153,  236 => 152,  232 => 150,  209 => 129,  207 => 128,  174 => 98,  124 => 51,  120 => 50,  116 => 49,  112 => 47,  101 => 38,  99 => 37,  94 => 34,  92 => 33,  87 => 31,  62 => 9,  54 => 8,  49 => 6,  44 => 4,  41 => 3,  39 => 2,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("{% set tienda = 'configuracion_tienda' | get('',null,null,{})[0] %}
...
{% endif %}", "index.twig", "/var/www/vhosts/ws.cocosolution.com/httpdocs/cms/lib/plugins/builder_saas/modulos/cache/layoutscabeceraantigua_xvok48f");
    }
}
}
...
$acaiResultData = new __TwigTemplate_e4005be774059c8beecc19c38b82fdb1493c6d065aae303280d3af2e3b01822f($twig);
