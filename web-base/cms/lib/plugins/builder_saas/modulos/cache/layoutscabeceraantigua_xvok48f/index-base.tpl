...
<nav class="sticky top-0 navbar-wrapper aaaap-2 aaaalg:p-3 w-full z-30 bg-old-gradient--header transition3s" c-class="{ 'educacion': thisrecord.tableName is same as('apartados_edu') }">
    ...
    <nuevomenu_m7gx9k></nuevomenu_m7gx9k>
    <div c-if="false" class="container-full sm:mx-auto px-2 lg:px-2 flex items-center justify-between text-white">
        <div class="flex items-center flex-row lg:flex-row flex-shrink-0">
            <div c-if="not request.modo_restringido" class="block mr-2 lg:mr-0">
        ...
        <div class="navbar w-full block text-md font-normal flex w-auto justify-end lg:justify-between py-0">
            ...
            <div class="flex flex-row flex-shrink-0">
                ...
                <a c-if="not session.user" href="/login/" class="menuLink relative menu block flex items-center py-2 lg:py-0 mr-0 lg:mr-4 px-2 hover:text-black text-xs text-right leading-tight">
                ...
                <span c-if="session.user" class="menuLink relative menu block flex items-center py-2 lg:py-0 mr-0 lg:mr-4 px-2 hover:text-black text-xs text-right leading-tight">
                    ...
                    <div class="submenu hidden absolute top-100 right-0 w-64 text-left bg-white p-4 shadow-lg border-t-4 border-orange-500">
                        <ul>
                            ...
                            <li c-for="apartado in apartados" c-where="'parentNum=21 and visible_en_el_menu=1'" c-order="'siblingOrder ASC'"><a href="{{apartado.enlace}}" class="block flex items-center py-2 hover:bg-gray-200 px-2">{{apartado.name}}</a></li>
                            <li><a href="/?cerrarsesion=1" class="block flex items-center py-2 hover:bg-gray-200 px-2">Cerrar sesión</a></li>
                        </ul>
                    </div>
                </span>
                
                <span c-if="tienda.tienda_activa" class="menuLink relative menu block flex items-center py-2 lg:py-0 mr-0 lg:mr-4 px-2 hover:text-black text-white text-xs text-right leading-tight">
                    <button onclick="toggleSubmenu(this.parentNode)" class="hidden xl:block text-right">
                        {{'Mi <br />
                    ...
                    <div class="submenu hidden absolute top-100 right-0 w-64 text-left bg-white p-4 shadow-lg border-t-4 border-orange-500">
                        <cestawidgetcesta></cestawidgetcesta>
                    </div>
                </span>
            </div>
        </div>
...
<appavisoweb_y45157></appavisoweb_y45157>
{% endif %}