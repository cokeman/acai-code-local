<template>
    <div class="relative">
        <input type="color" class="h-16 p-2 w-full text-sm appearance-none bg-gray-200 border-gray-600 border-2 rounded-lg shadow" v-model="data[field].newValues.builder_custom.value" @change="saveData()">
